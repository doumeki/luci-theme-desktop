...
(function() {
    ...
    window.__I18N = {
        'zh_cn': {
            ...
            'Tip: {host} is the address you are using now — http://{host}:300 reaches this router on port 300 (also {port}, {proto}, {origin}).': '提示：{host} 是你当前访问的地址——http://{host}:300 可访问本路由的 300 端口（另支持 {port}、{proto}、{origin}）。',
